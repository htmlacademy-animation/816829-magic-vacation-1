...
/*!***********************************************!*\
  !*** ./source/js/helpers/document-helpers.js ***!
  \***********************************************/
/*! exports provided: scrollIntoViewIfNeeded, findAncestor, isPortrait, isMobileOrPortrait, sleep, addClassToken, reloadSvg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const calculateFrameId = (fps, progress, duration) => {
  return Math.floor(progress * duration / _time_helpers__WEBPACK_IMPORTED_MODULE_0__["MILLISECONDS_IN_SECOND"] * fps);
};
...
class FullPageScroll {
  ...
  setCurrentScreenIndex(index) {
    ...
    this.dispatchEvent(helpers_screen_helpers__WEBPACK_IMPORTED_MODULE_2__["ScreenEventType"].SCREEN_CHANGE);
  }
  ...
  deactivatePreviousScreen() {
    ...
    this.onPreviousScreenHidden = () => {
      ...
      this.dispatchEvent(helpers_screen_helpers__WEBPACK_IMPORTED_MODULE_2__["ScreenEventType"].PREVIOUS_SCREEN_HIDDEN);
    };
  ...
  activateCurrentScreen() {
    ...
    this.onCurrentScreenActive = () => {
      ...
      this.dispatchEvent(helpers_screen_helpers__WEBPACK_IMPORTED_MODULE_2__["ScreenEventType"].CURRENT_SCREEN_ACTIVE);
    };
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const showResult = (result) => {
    Object(helpers_document_helpers__WEBPACK_IMPORTED_MODULE_0__["reloadSvg"])(result.querySelector(`.result__title svg`));
